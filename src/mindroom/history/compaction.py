...
from mindroom.constants import MINDROOM_COMPACTION_CHUNK_TIMEOUT_SECONDS, MINDROOM_COMPACTION_TOTAL_TIMEOUT_SECONDS
from mindroom.history.storage import update_scope_seen_event_ids, write_scope_state
...
async def compact_scope_history(
    *,
    ...
    try:
        async with asyncio.timeout(MINDROOM_COMPACTION_TOTAL_TIMEOUT_SECONDS):
        ...
        msg = f"compaction timed out after {MINDROOM_COMPACTION_TOTAL_TIMEOUT_SECONDS}s"
...
def _persist_compaction_progress(
    *,
    ...
    target_session.metadata = {
        **(target_session.metadata or {}),
        **(working_session.metadata or {}),
    }
